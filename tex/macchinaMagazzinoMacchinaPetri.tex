\begin{figure}[!h]
  ...
  \node [transition,label=left:$t_{13}$] (t13) [below right of=pi1] {}
  edge [pre] (pb1)
  edge [pre] (pm2)
  edge [post] (pm1)
  ...
  % MACCHINA
    \node [transition,label=right:$t_{21}$] (t21) [below left of=pi2]{}
    edge [pre] (pm1)
  ...
  \begin{scope}[xshift=6cm]
    ...
    \node [transition,label=right:$t_{23}$] (t23) [below right of=pi2] {}
    edge [pre] (pb2)
